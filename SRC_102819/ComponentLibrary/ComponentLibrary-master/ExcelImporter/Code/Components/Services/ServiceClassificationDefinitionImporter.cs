...
{
    public class ServiceClassificationDefinitionImporter
    {
        private readonly Logger _logger;
        private readonly IWebClient<Dictionary<string, Dictionary<string, string>>> _webClient;

        public ServiceClassificationDefinitionImporter(IWebClient<Dictionary<string, Dictionary<string, string>>> webClient)
        {
