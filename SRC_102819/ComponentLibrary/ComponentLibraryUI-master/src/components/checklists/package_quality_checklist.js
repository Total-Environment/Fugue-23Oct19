...
import {PackageQualityChecklistFooter} from "./package_quality_checklist_footer";
import {logoDark} from '../sidebar/index.css';
import {Icon} from '../icon';

export class PackageQualityChecklist extends Component {
  render() {
